...
namespace HrAPI.Migrations
{
    ...
    [Migration("20230206022901_create")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AccountRolesAccounts", b =>
                {
                    ...
                    b.HasKey("AccountRolesId", "AccountsNIK");

                    b.HasIndex("AccountsNIK");

                    b.ToTable("AccountRolesAccounts");
                });
            ...
            modelBuilder.Entity("AccountRolesAccounts", b =>
                {
                    b.HasOne("HrAPI.Model.AccountRoles", null)
                        .WithMany()
                        .HasForeignKey("AccountRolesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("HrAPI.Model.Accounts", null)
                        .WithMany()
